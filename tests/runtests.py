...
TEST_TYPES = {
    ...
    'jld:FrameTest': {
        'pending': {
            'idRegex': [
                # misc
                '.*frame-manifest#t0011$',
                '.*frame-manifest#t0016$',
                # graphs
                '.*frame-manifest#t0020$',
                '.*frame-manifest#t0023$',
                '.*frame-manifest#t0026$',
                '.*frame-manifest#t0027$',
                '.*frame-manifest#t0028$',
                '.*frame-manifest#t0029$',
                '.*frame-manifest#t0030$',
                '.*frame-manifest#t0031$',
                '.*frame-manifest#t0032$',
                #'.*frame-manifest#t0033$',
                '.*frame-manifest#t0034$',
                '.*frame-manifest#t0035$',
                '.*frame-manifest#t0036$',
                '.*frame-manifest#t0037$',
                '.*frame-manifest#t0038$',
                '.*frame-manifest#t0039$',
                '.*frame-manifest#t0046$',
                '.*frame-manifest#t0040$',
                '.*frame-manifest#t0041$',
                '.*frame-manifest#t0042$',
                '.*frame-manifest#t0043$',
                '.*frame-manifest#t0044$',
                '.*frame-manifest#t0045$',
                '.*frame-manifest#t0047$',
                '.*frame-manifest#t0048$',
                '.*frame-manifest#t0049$',
                '.*frame-manifest#t0050$',
                '.*frame-manifest#t0051$',
                # blank nodes
                '.*frame-manifest#t0052$',
                '.*frame-manifest#t0053$',
                # embed
                '.*frame-manifest#t0054$',
                # lists
                '.*frame-manifest#t0055$',
                '.*frame-manifest#t0058$',
                # @embed:@first
                '.*frame-manifest#t0060$',
                # wildcard
                '.*frame-manifest#t0061$',
                '.*frame-manifest#t0062$',
                '.*frame-manifest#t0063$',
                '.*frame-manifest#t0064$',
                '.*frame-manifest#t0065$',
                '.*frame-manifest#t0066$',
                '.*frame-manifest#t0067$',
                '.*frame-manifest#t0068$',
                # misc
                #'.*frame-manifest#tp010$',
                '.*frame-manifest#teo01$',
                '.*frame-manifest#tp050$',
                # ex
                '.*frame-manifest#tg001$',
                '.*frame-manifest#tg002$',
                '.*frame-manifest#tg003$',
                '.*frame-manifest#tg004$',
                '.*frame-manifest#tg006$',
                '.*frame-manifest#tg007$',
                '.*frame-manifest#tg008$',
                '.*frame-manifest#tg009$',
                '.*frame-manifest#tg010$',
                '.*frame-manifest#tp046$',
                '.*frame-manifest#tp049$',
                # included
                '.*frame-manifest#tin01$',
                '.*frame-manifest#tin02$',
                '.*frame-manifest#tin03$',
                # requireAll
                '.*frame-manifest#tra01$',
                '.*frame-manifest#tra02$',
                '.*frame-manifest#tra03$',
            ]
        },
        'skip': {
            # skip tests where behavior changed for a 1.1 processor
